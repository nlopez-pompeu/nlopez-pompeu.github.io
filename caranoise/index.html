...
function draw() {
  ...
  let x=random(0,50);
  let y=100*noise(0.05*frameCount);
  frameRate(5);
 ...
 ellipse(265,160,30+y,25+y);//Formade l'ull dret perque x=160
 fill(0,0,0)
  ellipse(265,160,15,13)
 fill(255, 255, 255)
  ellipse(337,160,30+y,25+y);//Forma de l'ull esquerra perquè x=350
  fill(0,0,0)
  ellipse(337,160,15,13)
 fill(255,110,110);//Color de la boca
arc(300,240,90,50+x,0,PI);//Forma de la boca
}
